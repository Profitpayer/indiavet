...
class Home09DashboardWidget extends StatefulWidget {
  ...
  static String routeName = 'Home09Dashboard';
  static String routePath = '/home09Dashboard';
                        ...
                        children: [
                          Container(
                            ...
                            child: Padding(
                              ...
                              child: Text(
                                FFLocalizations.of(context).getText(
                                  'bcb4foou' /* Below is a summary of your tea... */,
                                ),
                                        ...
                                        children: [
                                          ...
                                          Padding(
                                            ...
                                            child: Text(
                                              FFLocalizations.of(context)
                                                  .getText(
                                                'u9pw25r7' /* Below is an a summary of activ... */,
                                              ),
                                              style:
                                                  FlutterFlowTheme.of(context)
                                                      .labelMedium
                                        ...
                                        children: [
                                          ...
                                          Padding(
                                            ...
                                            child: Text(
                                              FFLocalizations.of(context)
                                                  .getText(
                                                'p71dvi32' /* Below is an a summary of activ... */,
                                              ),
                                              style:
                                                  FlutterFlowTheme.of(context)
                                                      .labelMedium
