...
class _MRListWidgetState extends State<MRListWidget> {
  late MRListModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => MRListModel());
                          ...
                          children: [
                            Text(
                              FFLocalizations.of(context).getText(
                                'rtooq07b' /* Medical Representative */,
                              ),
                            ...
                            Text(
                              FFLocalizations.of(context).getText(
                                'u6elhbgs' /* Our Best Veterinary Doctor */,
                              ),
