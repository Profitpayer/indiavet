...
import 'doctor_panel_model.dart';
export 'doctor_panel_model.dart';

class DoctorPanelWidget extends StatefulWidget {
  const DoctorPanelWidget({super.key});

  static String routeName = 'DoctorPanel';
  static String routePath = '/doctorPanel';

  @override
  State<DoctorPanelWidget> createState() => _DoctorPanelWidgetState();
}

class _DoctorPanelWidgetState extends State<DoctorPanelWidget> {
  late DoctorPanelModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => DoctorPanelModel());
                                          ...
                                          child: Padding(
                                            ...
                                            child: Text(
                                              FFLocalizations.of(context)
                                                  .getText(
                                                'psl5mfh1' /* Our Specialists & Community */,
                                              ),
                                              style:
                                    ...
                                    children: [
                                      Text(
                                        FFLocalizations.of(context).getText(
                                          'otpvh0h3' /* Our Services in your city */,
                                        ),
                                        style: FlutterFlowTheme.of(context)
                                            .headlineSmall
                                            .override(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    Padding(
                                      ...
                                      child: Text(
                                        FFLocalizations.of(context).getText(
                                          '4epe4t64' /* Our Veterinary Products */,
                                        ),
                                        style: FlutterFlowTheme.of(context)
                                            .headlineSmall
                                            .override(
                                          ...
                                          child: Column(
                                            ...
                                            children: [
                                              ...
                                              Text(
                                                FFLocalizations.of(context)
                                                    .getText(
                                                  'e9xjd5mn' /* Ensure your pet gets daily exe... */,
                                                ),
                                                style:
                                                    FlutterFlowTheme.of(context)
                                                        .bodyMedium
                                          ...
                                          child: Column(
                                            ...
                                            children: [
                                              ...
                                              Text(
                                                FFLocalizations.of(context)
                                                    .getText(
                                                  'vd1530mt' /* Provide a nutritious diet appr... */,
                                                ),
                                                style:
                                                    FlutterFlowTheme.of(context)
                                                        .bodyMedium
                  ...
                  Align(
                    ...
                    child: SafeArea(
                      child: Container(
                        ...
                        alignment: AlignmentDirectional(0.0, 1.0),
                        child: wrapWithModel(
                          model: _model.doctornavigationModel,
                          updateCallback: () => safeSetState(() {}),
                          child: DoctornavigationWidget(),
                        ),
                      ),
                    ),
                  ),
