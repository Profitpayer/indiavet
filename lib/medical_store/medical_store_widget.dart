...
class MedicalStoreWidget extends StatefulWidget {
  ...
  static String routeName = 'MedicalStore';
  static String routePath = '/MedicalStore';
                                      ...
                                      child: Padding(
                                        ...
                                        child: Text(
                                          FFLocalizations.of(context).getText(
                                            'txgh0a90' /* Our Specialists & Community */,
                                          ),
                                          style: FlutterFlowTheme.of(context)
                                              .displaySmall
                                              .override(
                                                          ...
                                                          Padding(
                                                            ...
                                                            child: Text(
                                                              FFLocalizations.of(
                                                                      context)
                                                                  .getText(
                                                                'dqkcpozk' /* Generate Prescription */,
                                                              ),
                                                              textAlign:
                                                                  TextAlign
                                                                      .center,
                                                          ...
                                                          Align(
                                                            ...
                                                            child: Padding(
                                                              ...
                                                              child: Container(
                                                                ...
                                                                child: Image
                                                                    .network(
                                                                  'https://img.freepik.com/premium-vector/medical-report-prescription-drug-rx-with-pills-capsule-clipboard_1072830-1066.jpg',
                                                                  fit: BoxFit
                                                                      .cover,
                                                                ),
                                                              ),
                            ...
                            child: Column(
                              ...
                              children: [
                                Padding(
                                  ...
                                  child: Text(
                                    FFLocalizations.of(context).getText(
                                      'kjflghn8' /* Our Veterinary Products */,
                                    ),
                                    style: FlutterFlowTheme.of(context)
                                        .headlineSmall
                                        .override(
