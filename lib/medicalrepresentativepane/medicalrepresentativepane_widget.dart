...
import 'medicalrepresentativepane_model.dart';
export 'medicalrepresentativepane_model.dart';

class MedicalrepresentativepaneWidget extends StatefulWidget {
  const MedicalrepresentativepaneWidget({super.key});

  static String routeName = 'Medicalrepresentativepane';
  static String routePath = '/medicalrepresentativepane';

  @override
  State<MedicalrepresentativepaneWidget> createState() =>
      _MedicalrepresentativepaneWidgetState();
}

class _MedicalrepresentativepaneWidgetState
    extends State<MedicalrepresentativepaneWidget> {
  late MedicalrepresentativepaneModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => MedicalrepresentativepaneModel());
  ...
  Widget build(BuildContext context) {
    return Title(
        title: 'Medicalrepresentativepane',
                    ...
                    children: [
                                      ...
                                      child: Padding(
                                        ...
                                        child: Text(
                                          FFLocalizations.of(context).getText(
                                            'dlb4vjuw' /* Our Specialists & Community */,
                                          ),
                                          style: FlutterFlowTheme.of(context)
                                              .displaySmall
                                              .override(
                                                    ...
                                                    child: ClipRRect(
                                                      borderRadius:
                                                          BorderRadius.circular(
                                                              8.0),
                                                      child: Image.network(
                                                        'https://img.freepik.com/free-vector/farmer-playing-with-cute-dog-white-background_1308-50818.jpg',
                                                        width: 100.0,
                                                        height: 100.0,
                                                        fit: BoxFit.cover,
                                                      ),
                      ...
                      Padding(
                        ...
                        child: InkWell(
                          ...
                          highlightColor: Colors.transparent,
                          onTap: () async {
                            context.pushNamed(ProductCategoryWidget.routeName);
                          },
                          child: Container(
                            width: double.infinity,
                            height: 150.1,
                            ...
                            child: Column(
                              ...
                              children: [
                                Padding(
                                  ...
                                  child: Text(
                                    FFLocalizations.of(context).getText(
                                      'x6y1y01u' /* Our Veterinary Products */,
                                    ),
                                    style: FlutterFlowTheme.of(context)
                                        .headlineSmall
                                        .override(
                                            ...
                                            Column(
                                              ...
                                              children: [
                                                ...
                                                Text(
                                                  FFLocalizations.of(context)
                                                      .getText(
                                                    'c38pzk73' /* Processed • May 15, 2023 */,
                                                  ),
                                                  style: FlutterFlowTheme.of(
                                                          context)
                                                      .bodySmall
                                            ...
                                            Column(
                                              ...
                                              children: [
                                                ...
                                                Text(
                                                  FFLocalizations.of(context)
                                                      .getText(
                                                    'a0vnhuap' /* Processed • May 15, 2023 */,
                                                  ),
                                                  style: FlutterFlowTheme.of(
                                                          context)
                                                      .bodySmall
                                            ...
                                            child: Column(
                                              ...
                                              children: [
                                                ...
                                                Text(
                                                  FFLocalizations.of(context)
                                                      .getText(
                                                    'bbba10hh' /* Cardiologist • 10:30 AM */,
                                                  ),
                                                  style: FlutterFlowTheme.of(
                                                          context)
                                                      .bodySmall
                            ...
                            children: [
                              ...
                              Container(
                                ...
                                child: Slider(
                                  ...
                                  min: 0.0,
                                  max: 50000.0,
                                  value: _model.sliderValue ??= 45678.0,
                                  onChanged: (newValue) {
              ...
              Align(
                ...
                child: SafeArea(
                  child: Container(
                    ...
                    alignment: AlignmentDirectional(0.0, 1.0),
                    child: wrapWithModel(
                      model: _model.mRnavigationModel,
                      updateCallback: () => safeSetState(() {}),
                      child: MRnavigationWidget(),
                    ),
                  ),
                ),
              ),
