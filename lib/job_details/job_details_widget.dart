                                          ...
                                          children: [
                                            Text(
                                              FFLocalizations.of(context)
                                                  .getText(
                                                '7hrqorkj' /*  Hydrogen peroxide- IP/BP  */,
                                              ),
                                        ...
                                        text: TextSpan(
                                          children: [
                                            ...
                                            TextSpan(
                                              text: FFLocalizations.of(context)
                                                  .getText(
                                                'mxdb8xpv' /* written document that outlines... */,
                                              ),
                                              style:
                                                  FlutterFlowTheme.of(context)
                                                      .bodyMedium
