...
class NoticeWidget extends StatefulWidget {
  ...
  static String routePath = '/notice';
                            ...
                            tabs: [
                              ...
                              FutureBuilder<int>(
                                ...
                                builder: (context, snapshot) {
                                  ...
                                  int offersCount = snapshot.data!;

                                  return Tab(
                                    text: 'Offers  ${offersCount.toString()}',
                                    icon: Icon(
                                      Icons.local_offer,
                                    ),
                                  );
                              ...
                              FutureBuilder<int>(
                                ...
                                builder: (context, snapshot) {
                                  ...
                                  int newsCount = snapshot.data!;

                                  return Tab(
                                    text: 'News ${newsCount.toString()}',
                                    icon: FaIcon(
                                                                  ...
                                                                  children: [
                                                                    TextSpan(
                                                                      text: FFLocalizations.of(
                                                                              context)
                                                                          .getText(
                                                                        '77vsuljd' /* RichText allows for various st... */,
                                                                      ),
                                                                      style: FlutterFlowTheme.of(
                                                                              context)
                                                                          .bodyMedium
