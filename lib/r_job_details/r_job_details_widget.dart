...
class _RJobDetailsWidgetState extends State<RJobDetailsWidget> {
  late RJobDetailsModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => RJobDetailsModel());
                                          ...
                                          children: [
                                            Text(
                                              FFLocalizations.of(context)
                                                  .getText(
                                                'fgtdviag' /*  Hydrogen peroxide- IP/BP  */,
                                              ),
                                        ...
                                        text: TextSpan(
                                          children: [
                                            ...
                                            TextSpan(
                                              text: FFLocalizations.of(context)
                                                  .getText(
                                                'vb52qi5p' /* written document that outlines... */,
                                              ),
                                              style:
                                                  FlutterFlowTheme.of(context)
                                                      .bodyMedium
