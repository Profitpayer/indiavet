          ...
          child: Column(
            ...
            children: [
              Align(
                ...
                child: Padding(
                  padding:
                      EdgeInsetsDirectional.fromSTEB(48.0, 10.0, 48.0, 0.0),
                  child: Container(
                          ...
                          AuthUserStreamWidget(
                            builder: (context) => FFButtonWidget(
                              ...
                              text: FFLocalizations.of(context).getText(
                                'jmws8ap0' /* Generate Prescription */,
                              ),
              ...
              if (valueOrDefault(currentUserDocument?.role, '') == 'Farmer')
                AuthUserStreamWidget(
                            ...
                            Padding(
                              ...
                              child: Row(
                                ...
                                children: [
                                  FFButtonWidget(
                                    onPressed: () async {
                                      context.goNamed(FarmerWidget.routeName);
                                    },
                                    text: FFLocalizations.of(context).getText(
                                      'rlj8xfny' /* No */,
                                    ),
                                  ...
                                  FFButtonWidget(
                                    onPressed: () async {
                                      context
                                          .goNamed(OurDoctorsWidget.routeName);
                                    },
                                    text: FFLocalizations.of(context).getText(
                                      'eliq5p81' /* Yes */,
                                    ),
