...
import 'edit_addproduct_model.dart';
export 'edit_addproduct_model.dart';

class EditAddproductWidget extends StatefulWidget {
  const EditAddproductWidget({super.key});

  static String routeName = 'EditAddproduct';
  static String routePath = '/editAddproduct';

  @override
  State<EditAddproductWidget> createState() => _EditAddproductWidgetState();
}

class _EditAddproductWidgetState extends State<EditAddproductWidget> {
  late EditAddproductModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => EditAddproductModel());
    ...
    _model.producapercestageTextController1 ??= TextEditingController();
    _model.producapercestageFocusNode1 ??= FocusNode();

    _model.producapercestageTextController2 ??= TextEditingController();
    _model.producapercestageFocusNode2 ??= FocusNode();

    _model.producapercestageTextController3 ??= TextEditingController();
    _model.producapercestageFocusNode3 ??= FocusNode();
                                ...
                                Row(
                                  ...
                                  children: [
                                    ...
                                    Expanded(
                                      child: TextFormField(
                                        controller: _model
                                            .producapercestageTextController1,
                                        focusNode:
                                            _model.producapercestageFocusNode1,
                                        autofocus: false,
                                        obscureText: false,
                                        decoration: InputDecoration(
                                          labelStyle:
                                ...
                                Row(
                                  ...
                                  children: [
                                    ...
                                    Expanded(
                                      child: TextFormField(
                                        controller: _model
                                            .producapercestageTextController2,
                                        focusNode:
                                            _model.producapercestageFocusNode2,
                                        autofocus: false,
                                        obscureText: false,
                                        decoration: InputDecoration(
                                          labelStyle:
                                ...
                                Row(
                                  ...
                                  children: [
                                    ...
                                    Expanded(
                                      child: TextFormField(
                                        controller: _model
                                            .producapercestageTextController3,
                                        focusNode:
                                            _model.producapercestageFocusNode3,
                                        autofocus: false,
                                        obscureText: false,
                                        decoration: InputDecoration(
                                          labelStyle:
